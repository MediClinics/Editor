...
import { type IEventPropTypes } from './components/EditorPropTypes';
...
export declare const getTinymceOrError: (view: Window) => TinyMCE;
export declare const isDisabledOptionSupported: (editor: TinyMCEEditor) => boolean;
export {};
